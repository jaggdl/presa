...
class ReadWorkspaceInvocationsToolTest < ActiveSupport::TestCase
  ...
  test "returns the workspace's recent tool invocations" do
    ...
    ToolInvocation.record!(api_token: ws.api_tokens.active.take, service: services(:places), tool_name: "places_text_search", arguments: {})
    ...
    assert_includes names, "places_text_search"

...
# `test/tools/strava/` includes this module to get a bound tool whose API
...
module StravaToolTestHelper
  ...
  def expose_strava_tool(kind, &stub_block)
    ...
    fake_service.define_singleton_method(:client) do |base_url: "https://www.strava.com/api/v3"|

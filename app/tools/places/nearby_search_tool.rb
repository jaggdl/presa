...
module Places
  ...
  class NearbySearchTool < Base
    ...
    arguments do
      ...
      optional(:included_types).filled(:array).each(:string).description("Place types (from Table A) to include, e.g. ['restaurant', 'cafe']")
      optional(:excluded_types).filled(:array).each(:string).description("Place types (from Table A) to exclude")
      optional(:included_primary_types).filled(:array).each(:string).description("Primary place types (from Table A) to include")
      optional(:excluded_primary_types).filled(:array).each(:string).description("Primary place types (from Table A) to exclude")

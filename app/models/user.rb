class User < ApplicationRecord
  ...
  DUMMY_PASSWORD_DIGEST = BCrypt::Password.create("dummy-password-for-timing", cost: BCrypt::Engine.cost).to_s.freeze
  ...
  # counter is reset.
  def self.attempt_login(email_address, password)
